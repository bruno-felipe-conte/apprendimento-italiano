...
const STATIC = [
  ...
  './css/italia.css',
  './css/styles.css',
  // JS — módulos da aplicação (URLs com ?v=67 para forçar atualização de cache)
  './js/audio.js?v=67',
  './js/conquistas.js?v=67',
  './js/core.js?v=67',
  './js/dialoghi.js?v=67',
  './js/canzoni.js?v=67',
  './js/imitazione.js?v=67',
  './js/flashcards.js?v=67',
  './js/grammar.js?v=67',
  './js/heatmap.js?v=67',
  './js/onboarding.js?v=67',
  './js/profilo.js?v=67',
