...
const STATIC = [
  ...
  './css/italia.css',
  './css/styles.css',
  // JS — módulos da aplicação (URLs com ?v=63 para forçar atualização de cache)
  './js/audio.js?v=63',
  './js/conquistas.js?v=63',
  './js/core.js?v=63',
  './js/dialoghi.js?v=63',
  './js/canzoni.js?v=63',
  './js/imitazione.js?v=63',
  './js/flashcards.js?v=63',
  './js/grammar.js?v=63',
  './js/heatmap.js?v=63',
  './js/onboarding.js?v=63',
  './js/profilo.js?v=63',
