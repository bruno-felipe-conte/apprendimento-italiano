...
const STATIC = [
  ...
  './css/italia.css',
  './css/styles.css',
  // JS — módulos da aplicação (URLs com ?v=64 para forçar atualização de cache)
  './js/audio.js?v=64',
  './js/conquistas.js?v=64',
  './js/core.js?v=64',
  './js/dialoghi.js?v=64',
  './js/canzoni.js?v=64',
  './js/imitazione.js?v=64',
  './js/flashcards.js?v=64',
  './js/grammar.js?v=64',
  './js/heatmap.js?v=64',
  './js/onboarding.js?v=64',
  './js/profilo.js?v=64',
