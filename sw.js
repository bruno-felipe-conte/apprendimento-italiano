...
const STATIC = [
  ...
  './css/italia.css',
  './css/styles.css',
  // JS — módulos da aplicação (URLs com ?v=68 para forçar atualização de cache)
  './js/audio.js?v=68',
  './js/conquistas.js?v=68',
  './js/core.js?v=68',
  './js/dialoghi.js?v=68',
  './js/canzoni.js?v=68',
  './js/imitazione.js?v=68',
  './js/flashcards.js?v=68',
  './js/grammar.js?v=68',
  './js/heatmap.js?v=68',
  './js/onboarding.js?v=68',
  './js/profilo.js?v=68',
