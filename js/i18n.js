...
const I18n = {
  ...
  dict: {
    ...
    'prof_stats_gerais': { pt: '📊 Estatísticas Gerais', it: '📊 Statistiche Generali' },
    'prof_nivel_atual': { pt: 'Nível atual', it: 'Livello attuale' },
    'prof_xp_total': { pt: 'XP total', it: 'XP totale' },
    'prof_streak_atual': { pt: 'Streak atual', it: 'Streak attuale' },
    'prof_fc_revisadas': { pt: 'Flashcards revisadas', it: 'Flashcard revisionate' },
    'prof_palavras_dom': { pt: 'Palavras dominadas', it: 'Parole dominate' },
    'prof_palavras_dif': { pt: 'Palavras difíceis', it: 'Parole difficili' },
    'prof_tempo_est': { pt: 'Tempo estimado', it: 'Tempo stimato' },
    'prof_templos_desb': { pt: 'Templos desbloqueados', it: 'Templi sbloccati' },
    'prof_acc_quiz': { pt: 'Precisão nos quizzes', it: 'Accuratezza quiz' },
    'prof_esta_semana': { pt: '📅 Esta Semana', it: '📅 Questa Settimana' },
    'prof_tot_sessoes': { pt: 'Total de sessões', it: 'Totale sessioni' },
    'prof_cards_est': { pt: 'Cartas estudadas', it: 'Card studiate' },
    'prof_xp_ganho': { pt: 'XP ganhos', it: 'XP guadagnato' },
    'prof_dias_ativos': { pt: 'Dias ativos', it: 'Giorni attivi' },
    'prof_cats_est': { pt: '📚 Categorias Mais Estudadas', it: '📚 Categorie Più Studiate' },
    'prof_traguardi': { pt: '🏆 Minhas Conquistas', it: '🏆 I Miei Traguardi' },
    'prof_velocidade_audio': { pt: '🎧 Velocidade do Áudio', it: '🎧 Velocità dell\'Audio' },
    'prof_testar_audio': { pt: '🔊 Testar Áudio', it: '🔊 Prova Audio' },
